...
\title{Identificación de una planta de 3 Opams (sistema de tercer orden) utilizando la estructura paramétrica ARMAX.}
...
\begin{itemize} \item Identificar el modelo de un planta de 3 Op-Amp?s a través de la adquisición de datos y de la estructura paramétrica ARMAX \end{itemize}
...
En este capitulo mostraremos los resultados del análisis anterior. LLegando a obtener:
\begin{itemize}
...
\begin{figure}[h!]
	...
	\graphicspath{./imagenes/}
 	\includegraphics[height=4cm]{./imagenes/data.png}
...
\begin{figure}[h!]
	\centering 
	\graphicspath{./imagenes/}
 	\includegraphics[height=4cm]{./imagenes/identificacion_arx.png}
...
\begin{figure}[h!]
	\centering 
	\graphicspath{./imagenes/}
 	\includegraphics[height=4cm]{./imagenes/pi_sistema_controlado.png}
...
\begin{figure}[h!]
	\centering 
	\graphicspath{./imagenes/}
 	\includegraphics[height=4cm]{./imagenes/pid_sistema_controlado.png}
...
\begin{figure}[h!]
	\centering 
	\graphicspath{./imagenes/}
 	\includegraphics[height=4cm]{./imagenes/compara_pi_pid.png}
